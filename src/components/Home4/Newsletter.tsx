        ...
        <>
            <div className="container">
                <div className={`newsletter-block md:py-20 sm:py-14 py-10 sm:px-8 px-6 sm:rounded-[32px] rounded-3xl flex flex-col items-center ${props}`}>
                    <div className="heading3 text-white text-center">Stay Connected for Exclusive Offers</div>
                    <div className='text-white text-center mt-3'>Get bulk pricing updates, new product catalogs, and special promotions</div>
