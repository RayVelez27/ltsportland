                            ...
                            <div className="menu-main h-full max-lg:hidden">
                                <ul className='flex items-center gap-8 h-full'>
                                    <li className='h-full relative'>
                                        ...
                                        <div className="sub-menu py-3 px-5 -left-10 w-max absolute grid grid-cols-4 gap-5 bg-white rounded-b-xl" style={{display: 'none'}}>
                                            <ul>
                                                <li>
                                    ...
                                    <li className='h-full' style={{display: 'none'}}>
                                    ...
                                    <li className='h-full relative'>
                                        <Link href="/pages/faqs" className={`text-button-uppercase duration-300 h-full flex items-center justify-center ${pathname === '/pages/faqs' ? 'active' : ''}`}>
                                            FAQ
                                        </Link>
                                    </li>
                                    <li className='h-full relative'>
                        ...
                        <div className="menu-main h-full overflow-hidden">
                            ...
                            <div className="list-nav mt-6">
                                <ul>
                                    ...
                                    >
                                        <a href={'#!'} className='text-xl font-semibold flex items-center justify-between mt-5'>Product OLD
                                            <span className='text-right'>
                                                <Icon.CaretRight size={20} />
                                            </span>
                                        </a>
                                    ...
                                    <li>
                                        <Link href="/pages/faqs" className='text-xl font-semibold flex items-center justify-between mt-5'>
                                            FAQ
                                        </Link>
                                    </li>
                                    <li>
                                    ...
                                    >
                                        <a href={'#!'} className='text-xl font-semibold flex items-center justify-between mt-5'>Pages OLD
                                            <span className='text-right'>
                                                <Icon.CaretRight size={20} />
                                            </span>
                                        </a>
